...
elseif(${Platform} STREQUAL "RK")
    add_definitions(-DRK)
    SET(CMAKE_C_COMPILER "/opt/rockchip/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf/bin/arm-linux-gnueabihf-gcc")
    SET(CMAKE_CXX_COMPILER "/opt/rockchip/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf/bin/arm-linux-gnueabihf-g++")
    SET(CMAKE_C_COMPILER_VERSION "8.3.0")
    SET(ToolPlatform "rk_arm-linux-gnueabihf")
